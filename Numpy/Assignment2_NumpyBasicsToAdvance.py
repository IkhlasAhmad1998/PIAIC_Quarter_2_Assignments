...
def function5():
    ...
    z = np.zeros((4,5), dtype=np.int)#wrtie your code here
...
def function9():
    ...
    a = np.arange(2,101,2, dtype=np.int) # write your code here
...
def function10():
    ...
    brr = np.array([1,2,3])
    subt = subt = arr - brr[:,np.newaxis]# write your code here
...
def function18():
    ...
    x = np.sum(np.in1d(students, piaic)) # Write you code Here
    return x
